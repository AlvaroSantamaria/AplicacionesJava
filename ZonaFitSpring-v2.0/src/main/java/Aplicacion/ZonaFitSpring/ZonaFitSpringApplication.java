package Aplicacion.ZonaFitSpring;

import Aplicacion.ZonaFitSpring.modelo.Cliente;
import Aplicacion.ZonaFitSpring.servicio.ClienteServicio;
import Aplicacion.ZonaFitSpring.servicio.IClienteServicio;
...
public class ZonaFitSpringApplication implements CommandLineRunner {
	...
	private boolean ejecutarOpciones(Scanner consola, int opcion){
		...
		switch (opcion) {
			...
			default -> logger.info(nl + "Opcion invalida: " + opcion + nl);
		}
		return salir;
	}
}
