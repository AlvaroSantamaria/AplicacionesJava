package Aplicacion.ZonaFitWeb.controlador;

import Aplicacion.ZonaFitWeb.modelo.Cliente;
import Aplicacion.ZonaFitWeb.servicio.IClienteServicio;
...
public class IndexControlador {
    ...
    public void guardarCliente(){
        logger.info("cliente a guardar: " + this.getClienteSeleccionado());
        // Agregar (insert)
        ...
        // Reset des objeto cliente seleccionado
